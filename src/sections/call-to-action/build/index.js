...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    min: 2,
    max: 6
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_number_control__WEBPACK_IMPORTED_MODULE_3__["default"], {
    label: "Gap",
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/call-to-action","version":"0.1.0","title":"Call To Action","category":"theme-blocks","icon":"flag","description":"A Gutenberg block to show your pride! This block enables you to type text and style it with the color font Gilbert from Type with Pride.","attributes":{"heading":{"type":"string","value":"Don\'t put a comma at the end of this line","source":"text","selector":"div","required":true},"columnCount":{"type":"integer","default":2},"columnGap":{"type":"integer","default":40},"columnWidth":{"type":"integer","default":200},"style":{"type":"object","default":{"color":{"text":"#3a3a3a","background":"#fbf9f4"},"spacing":{"padding":{"top":"1em","right":"20px","bottom":"20px","left":"20px"}}}}},"supports":{"align":["left","right","full"],"anchor":true,"ariaLabel":true,"color":{},"html":false,"spacing":{"margin":true,"padding":true,"blockGap":true}},"textdomain":"call-to-action","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkcall_to_action"] = globalThis["webpackChunkcall_to_action"] || [];
